...
You can see some screenshots[http://intraducibles.com/projects/typus].
...
You can view the available tasks running:
    ...
    rake typus:more         # Install typus_more.
...
implemented but you can easily add your own. You will see the export 
links on the sidebar of your resource.
...
Please notice that in order to be able to use the export feature you 
need the following routes at the end of your <tt>routes.rb</tt>.
...
Customize *Typus* interface by placing on <tt>views/admin</tt> your own 
views & partials. Typus defaults are good enough but sometimes you need more 
features.
...
Under <tt>app/view/admin/articles</tt> drop the file <tt>index.html.erb</tt> 
and *Typus* default <tt>index.html.erb</tt> will be replaced. Easy, isn't it?

=== Blocks on views (partials)

Here's a list of available blocks you can add to your application. *Typus* 
views will detect this files, if they're in the right place.
...
*Typus* has roles support and you can add as many roles as you want. 
Define them in your <tt>config/typus/application_roles.yml</tt> 
configuration file.
...
<tt>Mocha</tt> is required to test the plugin.

    $ sudo gem install mocha

Create an empty application and make sure you have the following routes 
...
To enable quick edit include the Admin::PublicHelper on your 
...
There's no a date for this new features, but are things which I'd like 
to see in Typus in the near future.

- Sphinx search integration when available.
- Search in multiple models.
- Nested models.
- Content Management System generator. (typus_more)
...
- Project site http://intraducibles.com/projects/typus
- Source http://github.com/fesplugas/typus
- Google Group http://groups.google.es/group/typus
- Bugs http://github.com/fesplugas/typus/wikis/bugs

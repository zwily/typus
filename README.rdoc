...
1. *Typus* is licensed under the MIT license. As an experiment we 
...
2. Hire us to work on your next project. We build large and small websites.

3. Contribute your patches to the community & support people on the 
mailing list.

4. Tell everybody about Typus, tell your friends and colleagues about 
...
And the actions for those export options are:
    ...
    def export_csv
      # Which is already implemented but you can overwrite. On 
    ...
    def export_pdf
      # Not implemented, you will have to overwrite on 
      # `admin/orders_controller.rb`.
    end

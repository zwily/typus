...
To test the plugin create an empty application and remove the default 
routes on <tt>routes.rb</tt>, once the application is created install 
the plugin and run rake.

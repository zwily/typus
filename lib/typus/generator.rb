  ...
  def self.generator
    ...
    resources.each do |resource|
      ...
      if !admin_controllers.include?(controller_filename)
        ...
        content = <<-RAW
# Controller auto-generated by Typus, use it to extend the admin functionality.
...
<p>And here we do whatever we want to ...</p>
    ...
    models.each do |model|
      ...
      if !admin_controllers.include?(controller_filename)
        ...
        content = <<-RAW
# Controller generated by Typus, use it to extend the admin functionality.
...
=end
      ...
      if !admin_helpers.include?(helper_filename)
        ...
        content = <<-RAW
# Helper generated by Typus, use it to extend the admin functionality.
module Admin::#{model.pluralize}Helper
      ...
      if !admin_controller_tests.include?(test_filename) && File.directory?("#{Rails.root}/test")
        ...
        content = <<-RAW
# File generated by Typus, use it to test the extended admin functionality.
require 'test_helper'

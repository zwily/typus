...
##
class Admin::#{resource}Controller < AdminController
  ...
  skip_before_filter :find_record
  skip_before_filter :check_ownership_of_record
  skip_before_filter :check_if_user_can_perform_action_on_resource
  skip_before_filter :set_order_and_list_fields
  skip_before_filter :set_form_fields

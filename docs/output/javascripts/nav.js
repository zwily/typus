function create_menu(basepath)
{
	...
	document.write(
		...
		'<li><a href="#">Upgrading from a Previous Version</a></li>' +
		...
		'<li><a href="#">Typus at a Glance</a></li>' +
		'<li><a href="#">Supported Features</a></li>' +
		'<li><a href="#">Architectural Goals</a></li>' +
		'</ul>' +	
		...
		'<li><a href="/recipes/configuration-files/">Managing Configuration Files</a></li>' +
